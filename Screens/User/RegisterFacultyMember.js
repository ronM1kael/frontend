...
const RegisterFacultyMember = (props) => {
    ...
    const register = async () => {
        ...
        if (fname === "" || lname === "" || mname === "" || email === "" || password === ""
            || department === "" || position === "" || designation === "" || tup_id === "" || selectedGender === "" || phone === ""
            || address === "" || date === "") {
            ...
            let user = {
                ...
                email: email,
                password: password,
                role: "Faculty", // Assuming "role" is "student" for student registration
                position: position,
                department: department, // Fill this with the logic for the college
                designation: designation, // Fill this with the logic for the course
            ...
            axios
                .post(`${baseURL}facultymember/register`, user)
                .then((res) => {
                    console.log(res);
                    if (res.status === 200) {
                        Toast.show({
                ...
                >
                    ...
                    <View style={{ marginVertical: 22 }}>
                        ...
                        <Text style={{
                            fontSize: 16,
                            color: COLORS.black
                        }}>Note:  It is a prerequisite that all faculty member are actively employed at Technological University of the Philippines - Taguig Campus. Please provide your TUP ID number as part of the required information.</Text>
                    </View>
...
export default RegisterFacultyMember;