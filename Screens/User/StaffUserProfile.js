...
const StaffUserProfile = () => {
  ...
  const [staff, setProfileData] = useState(null);
        ...
        if (!jwtToken || !context.stateUser.isAuthenticated) {
          ...
          try {
            ...
            const response = await axios.get(
              `${baseURL}staffprofile/${userProfile.id}`,
              {
  ...
  return (
    ...
    <View style={styles.avatarContainer}>
        ...
        <Text style={styles.name}>
          {staff ? `${staff.fname} ${staff.mname} ${staff.lname}` : ''}
        </Text>
      </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.infoValue}>{staff ? staff.position : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Designation:</Text>
        <Text style={styles.infoValue}>{staff ? staff.designation : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Email:</Text>
        <Text style={styles.infoValue}>{staff ? staff.email : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Gender:</Text>
        <Text style={styles.infoValue}>{staff ? staff.gender : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Phone:</Text>
        <Text style={styles.infoValue}>{staff ? staff.phone : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Address:</Text>
        <Text style={styles.infoValue}>{staff ? staff.address : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Birthdate:</Text>
        <Text style={styles.infoValue}>{staff ? staff.birthdate : ""}</Text>
      </View>
      <TouchableOpacity style={styles.logoutButtons}>
        ...
        onPress={() => navigation.navigate("StaffEditProfile")}>Edit Profile</Text>
      </TouchableOpacity>
    </View>
    </KeyboardAwareScrollView>
  );
