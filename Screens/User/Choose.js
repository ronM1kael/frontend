    ...
    <View style={styles.container}>
      ...
      <View style={{ marginVertical: 22 }}>
        ...
        <Text style={{
          fontSize: 16,
          color: COLORS.black
        }}>All use must have a user profile to use the services. Please select how you will be using Redigitalize.</Text>
      ...
      <View style={{ marginVertical: 22 }}>
        ...
        <Text style={{
          fontSize: 16,
          color: COLORS.black
        }}>If you've used the service before, ther is no requirement to create a new user profile.
          <TouchableOpacity
