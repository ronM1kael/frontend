...
const RegisterStaff = (props) => {
    ...
    const register = async () => {
        ...
        if (fname === "" || lname === "" || mname === "" || email === "" || password === ""
            || position === "" || designation === "" || tup_id === "" || selectedGender === "" || phone === ""
            || address === "" || date === "") {
            ...
            let user = {
                ...
                email: email,
                password: password,
                role: "Staff", // Assuming "role" is "student" for student registration
                position: position,// Fill this with the logic for the college
            ...
            axios
                .post(`${baseURL}staff/register`, user)
                .then((res) => {
                    console.log(res);
                    if (res.status === 200) {
                        Toast.show({
                ...
                >
                    ...
                    <View style={{ marginVertical: 22 }}>
                        ...
                        <Text style={{
                            fontSize: 16,
                            color: COLORS.black
                        }}>Note:  It is a prerequisite that all staff are actively employed at Technological University of the Philippines - Taguig Campus. Please provide your TUP ID number as part of the required information.</Text>
                    </View>
