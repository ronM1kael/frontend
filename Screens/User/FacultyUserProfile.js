  ...
  return (
    ...
    <View style={styles.avatarContainer}>
        ...
        <Text style={styles.name}>
          {faculty ? `${faculty.fname} ${faculty.mname} ${faculty.lname}` : ''}
        </Text>
      </View>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.infoValue}>{faculty ? faculty.tup_id : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Department:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.department : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Position:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.position : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Designation:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.designation : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Email:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.email : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Gender:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.gender : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Phone:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.phone : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Address:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.address : ""}</Text>
      </View>
      <View style={styles.infoContainer}>
        <Text style={styles.infoLabel}>Birthdate:</Text>
        <Text style={styles.infoValue}>{faculty ? faculty.birthdate : ""}</Text>
      </View>
      <TouchableOpacity style={styles.logoutButtons}>
        ...
        <Text style={styles.logoutButtonTexts}
              onPress={() => navigation.navigate("FacultyEditProfile")}>Edit Profile</Text>
      </TouchableOpacity>
    </View>
    </KeyboardAwareScrollView>
  );
